...
public class CityPicker implements CanShow, OnWheelChangedListener {
     ...
     * Color.BLACK
     */
    private String cancelTextColorStr = "#5677ee";


    /**
     * Color.BLUE
     */
    private String confirmTextColorStr = "#5677ee";

    /**
     * 标题背景颜色
     */
    private String titleBackgroundColorStr = "#FAFAFA";
    /**
     * 标题颜色
     */
     ...
     */
    private String defaultCityName = "济南";

    /**
     * 第一次默认得显示，一般配合定位，使用
     */
    private String defaultDistrict = "市辖区";
