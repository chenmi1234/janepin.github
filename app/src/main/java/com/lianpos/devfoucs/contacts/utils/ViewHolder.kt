...
class ViewHolder : RecyclerView.ViewHolder {
        ...
        if (null != v) {
            if (visible) {
                if (null != v.layoutParams) {
                    v.layoutParams.width = AbsListView.LayoutParams.MATCH_PARENT
                    v.layoutParams.height = AbsListView.LayoutParams.WRAP_CONTENT
                } else {
                ...
                if (null != v.layoutParams) {
                    ...
                    v.layoutParams = AbsListView.LayoutParams(-1, 1)
                }
    ...
    fun setHItemVisible(visible: Boolean) {
        ...
        if (null != v) {
            if (visible) {
                if (null != v.layoutParams) {
                    v.layoutParams.width = AbsListView.LayoutParams.WRAP_CONTENT
                    v.layoutParams.height = AbsListView.LayoutParams.WRAP_CONTENT
                } else {
                    v.layoutParams = AbsListView.LayoutParams(AbsListView.LayoutParams.MATCH_PARENT, AbsListView.LayoutParams.WRAP_CONTENT)
                }
