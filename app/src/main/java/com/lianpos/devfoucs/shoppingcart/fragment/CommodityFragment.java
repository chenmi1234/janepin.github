...
import com.lianpos.devfoucs.shoppingcart.DoubleUtil;
import com.lianpos.devfoucs.shoppingcart.activity.IncreaseCommodityActivity;
import com.lianpos.devfoucs.shoppingcart.adapter.ShopAdapter;
import com.lianpos.devfoucs.shoppingcart.adapter.TestSectionedAdapter;
import com.lianpos.devfoucs.shoppingcart.assistant.ShopToDetailListener;
import com.lianpos.devfoucs.shoppingcart.assistant.onCallBackListener;
 ...
 * 服务商品列表
 */
public class CommodityFragment extends Fragment implements View.OnClickListener, onCallBackListener, ShopToDetailListener {
...
//    private TextView settlement;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater
                .inflate(R.layout.fragment_commodity_classify, container, false);
    }
...
//        settlement.setOnClickListener(this);
    ...
    public void setPrise() {
        ...
        shoppingNum.setText(String.valueOf(300));
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.toolBar:
                ...
                intent.setClass(getContext(),IncreaseCommodityActivity.class);
