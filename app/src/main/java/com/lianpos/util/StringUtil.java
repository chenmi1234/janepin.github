...
public class StringUtil {
	...
	/**
	 * 方法名称:isNullFM 方法描述:判断是字符串str是否等于str1，如果是返回toStr
	 * 
	 *            :
	 * @return String
	 * @author sdk_sunrk
	 * @date Sep 2, 2009
	 */
	public static String strToStr(String str, String str1, String toStr) {
		if (null == str || "".equals(str.trim()))
			str = "";
		if (str.equals(str1))
			str = toStr;
	...
	/**
	 * 方法名称:isNullFM 方法描述:判断是字符串是否为空,如果为空返回 ""
	 * 
	 * @param 
	 * @return String
	 * @author sdk_sunrk
	 * @date Sep 2, 2009
	 */
	public static String isNullFM(String str) {
		if (null == str || "".equals(str.trim()))
			return "";
		return str;
	}
	...
	/**
	 * 方法名称:isNullToStr 方法描述:判断是字符串是否为空,如果为空返回 toStr
	 * 
	 * @param 
	 *            :
	 * @return String
	...
	/*public static String getUid() {
		String timesCurrent = String.valueOf(System.currentTimeMillis());
		String timesNano = String.valueOf(System.nanoTime());
		String timetemp = timesCurrent+timesNano;
		String uid = MD5Util.md5Hex(timetemp);
		return uid;
	}*/
	/**
	 * 将以逗号分隔的字符串转换成字符串数组
